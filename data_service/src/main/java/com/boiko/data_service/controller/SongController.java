...
public class SongController {
    ...
    public ResponseEntity<?> uploadSong(
        ...
        try {
            Song song = songService.uploadSong(ids, audio, picture, dateOfPublication);
            String message = "Song %s will be published at %s".formatted(song.getName(), dateOfPublication);
            logger.info(message);
